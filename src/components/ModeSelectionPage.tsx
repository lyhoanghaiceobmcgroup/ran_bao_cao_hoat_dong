...
export default function ModeSelectionPage() {
  ...
  const handleModeSelect = (mode: 'start-shift' | 'end-shift') => {
    ...
    // Chuyển hướng đến dashboard tương ứng với chi nhánh
    if (selectedBranch === 'HN35') {
      navigate('/HN35-dashboard');
    } else if (selectedBranch === 'HN40') {
  ...
  const branches = [
    { code: 'HN01', name: 'Hà Nội - Hoàn Kiếm', status: 'active' },
    { code: 'HN02', name: 'Hà Nội - Cầu Giấy', status: 'active' },
    { code: 'HN03', name: 'Hà Nội - Đống Đa', status: 'maintenance' },
    { code: 'HN35', name: '35 Nguyễn Bỉnh Khiêm, Hà Nội', status: 'active' },
    { code: 'HN40', name: '40 Ngô Quyền, Hà Nội', status: 'active' },
    { code: 'SG01', name: 'Sài Gòn - Quận 1', status: 'active' },
    { code: 'SG02', name: 'Sài Gòn - Quận 3', status: 'active' },
    { code: 'DN01', name: 'Đà Nẵng - Hải Châu', status: 'active' }
  ];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-sm text-muted-foreground">Chuỗi Chi Nhánh RAN Group</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card className="shadow-card">
            <CardHeader>
              ...
              <CardDescription>
                Vui lòng chọn chi nhánh để thực hiện báo cáo ca
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Select
                ...
                disabled={userData.role === 'staff' && userData.branch !== 'ALL'}
              >
                ...
                <SelectContent>
                  {branches.map((branch) => (
                    <SelectItem 
                      key={branch.code} 
                      value={branch.code}
                      disabled={branch.status === 'maintenance'}
                    >
