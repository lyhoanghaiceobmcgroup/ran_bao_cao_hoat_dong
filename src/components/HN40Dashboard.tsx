...
export default function HN40Dashboard() {
  ...
  // Cố định chi nhánh HN40
  const selectedBranch = 'HN40';
  
  const handleModeSelect = (mode: 'start-shift' | 'end-shift') => {
    setSelectedBranch(selectedBranch);
    if (mode === 'start-shift') {
      navigate('/start-shift-40NQ');
    } else {
      navigate('/end-shift-40NQ');
    }
  };
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-sm text-muted-foreground">Chi Nhánh 40 Ngô Quyền, Hà Nội</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
